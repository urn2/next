<?php
//define ("QRCODE_DATA_PATH","/usr/local/apache2/htdocs/qrcode_php0.50beta11/qrcode_data");
define ("QRCODE_DATA_PATH",dirname(__FILE__).DIRECTORY_SEPARATOR.'qrcode_data');
/*
#
